...
namespace TatRom_BugTracker.Data
{
    public class DataUtility
    {
        ...
        //private const string _adminEmail = "tanyaromanova314@gmail.com";
        //private const string _moderatorEmail = "trmoderator@Mailinator.com";
        ...
        public static DateTime GetPostGresData(DateTime dateTime)
        {
        ...
        public static string GetConnectionString(IConfiguration configuration)
        {
            ...
            //connection string exist in the sicret
        ...
        {
            //Provides an object representation of a uniform resource identifier(URL) and easy access to the parts of the URI.
            //Uri - info will come from subUrl
        ...
        {
            //injecting 2 services
            //Obtaning the necessary services based on the IServiceProvider parametr
            //Service: An instance of Role manager
            var dbContextSvc = svcProvider.GetRequiredService<ApplicationDbContext>();
            //Service: An instance of RConfiguration Servicer
           // var userManagerSvc = svcProvider.GetRequiredService<IConfiguration<BTUser>();
            ...
            //Align the database data by cheching Migrations
            ...
            //Seed Demo User
            // await SeedDemoUserSync(userManagerSvs);
            //await SeedUsersAsync(dbContextSvc, configurationSvc, userManagerSvs);
        ...
        //private static async Task SeedUsersAsync(ApplicationDbContext context, IConfiguration configuration, UserManager<BTUser> userManager)
        //{
        //    //Seed Admin User
        //    if (!context.Users.Any(u => u.Email == _adminEmail))
        //    {
        //        BTUser adminUser = new()
        //        {
        //            Email = _adminEmail,
