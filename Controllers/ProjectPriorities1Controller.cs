...
{
    public class ProjectPriorities1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public ProjectPriorities1Controller(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: ProjectPriorities1
        ...
        // GET: ProjectPriorities1/Details/5
        ...
        // GET: ProjectPriorities1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ProjectPriorities1/Create
        ...
        // POST: ProjectPriorities1/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ProjectPriorities1/Delete/5
        ...
        // POST: ProjectPriorities1/Delete/5
